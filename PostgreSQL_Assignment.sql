...
-- Insert data into sighting table
...
LEFT JOIN sightings s ON r.ranger_id = s.ranger_id group by r.name;
...
FROM sightings s JOIN species sp ON s.species_id = sp.species_id 
